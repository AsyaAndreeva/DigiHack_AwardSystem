    ...
    return (
        <div className="animate-in fade-in duration-500 flex flex-col items-center justify-center min-h-[80vh] py-8 px-4 max-w-3xl mx-auto">
            ...
            <div className="text-center mb-16">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-md bg-[#C4FF00] shadow-[0_0_40px_rgba(196,255,0,0.3)] mb-8">
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-end justify-between">
                                ...
                                <div className="w-10 h-10 rounded-md bg-white/5 flex items-center justify-center group-hover:bg-white group-hover:text-[#0A1128] transition-all">
