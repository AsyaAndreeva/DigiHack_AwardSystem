    ...
    return (
        <div className="animate-in fade-in duration-500 min-h-screen">
            ...
            <div className="mb-12 flex flex-col items-center space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="w-16 h-16 rounded-md bg-brand-orange flex items-center justify-center shadow-[0_0_30px_rgba(243, 155, 45,0.3)] mb-2">
            ...
            <div className="w-full max-w-sm p-8 rounded-md glass border-l-4 border-brand-orange animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150">
                <form onSubmit={handleLogin} className="space-y-6">
                    <div className="space-y-3">
                        ...
                        <input
                            ...
                            placeholder="B7RX4K"
                            maxLength={8}
                            className="w-full p-5 bg-black/40 border border-white/10 rounded-md text-white placeholder:text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#F39B2D] focus:border-transparent transition-all tracking-[0.4em] text-center font-mono text-2xl uppercase"
                            required
                        />
